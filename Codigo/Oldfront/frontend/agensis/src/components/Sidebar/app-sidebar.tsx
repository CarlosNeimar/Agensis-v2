...
import { UserCog, Briefcase, MonitorCog, Video, Calendar, Home, CircleDollarSign, LayoutList, UserPlus, Brush, Star, ClipboardList, Package } from "lucide-react";
      ...
      <SidebarFooter>
        <div className="flex items-center space-x-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuLabel>Olá, {perfil}</DropdownMenuLabel>
              <DropdownMenuSeparator />
